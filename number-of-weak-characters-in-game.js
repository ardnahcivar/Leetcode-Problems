...
this character's attack and defense levels. More formally, a character i is said to be weak if there exists another character j where attackj > attacki and defensej > defensei.
 ...
 */
 var numberOfWeakCharacters = function(properties) {
    ...
    for(let i = 0; i < properties.length; i++){
        let curr = properties[i];
        if(curr[1] < maxDefence){
            count++   
        }
        maxDefence = Math.max(maxDefence, curr[1]);
    }
