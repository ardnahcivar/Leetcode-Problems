...
Both arrays are 0-indexed. The 0th key was pressed at the time 0, and every subsequent key was
 ...
 */
 var slowestKey = function(releaseTimes, keysPressed) {
    let maxObj = {[releaseTimes[0]]:keysPressed[0]};
    let maxValue = releaseTimes[0],maxKey = keysPressed[0];
    ...
    let keys = maxObj[maxValue];
    return keys.length > 1 ? keys.sort()[keys.length - 1] : maxKey;
};